                        ...
                        <div class="row g-3">
                            <div class="col-md-4 col-6">
                                <a href="{{ route('calendar') }}"
                                    class="card text-center shadow-sm h-100 quick-link-card text-decoration-none">
                            ...
                            {{--
                            <div class="col-md-4 col-6">
                                <a href="{{ route('payments.user.create') }}"
                                    class="card text-center shadow-sm h-100 quick-link-card text-decoration-none">
                                    <div class="card-body p-3">
                            ...
                            <div class="col-md-4 col-6">
                                <a href="{{ route('online-course.index') }}"
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <h6 class="card-title mb-1">Online Course</h6>
                                        <p class="text-muted small mb-0">Access Portal</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-4 col-6">
                                    ...
                                    <div class="position-relative">
                                        @if($event->image)
                                            <img src="{{ asset('storage/' . $event->image) }}" class="card-img-top"
                                                alt="{{ $event->title }}" style="height: 180px; object-fit: cover;">
                                        @else
