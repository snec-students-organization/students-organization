...
@section('content')
        ...
        <div class="hero-container">
            <div class="hero-content">
                ...
                <p class="hero-description d-none d-lg-block">
                    Join a vibrant community of innovators, thinkers, and creators. At SSO, we provide opportunities for
                    growth, networking, and skill development to help you excel in your academic and professional journey.
                </p>
                ...
                <div class="hero-buttons">
                    ...
                    <a href="{{ route('calendar') }}"
                        class="btn btn-secondary btn-sm d-block d-sm-inline-block mt-2 mt-sm-0 ms-sm-2">
    ...
    @if(isset($notifications) && $notifications->count())
        <a href="{{ route('notifications.index') }}" class="text-decoration-none">
            <div class="notification-bar bg-warning position-relative d-flex align-items-center shadow-lg"
                style="background: linear-gradient(135deg, #ff6b6b, #ff8e53) !important;">
                <!-- Fixed Label with Icon -->
                <div class="px-3 fw-bold d-flex align-items-center"
                    style="background: rgba(0,0,0,0.2); min-width: 140px; height: 100%;">
                ...
                <div class="marquee-container flex-grow-1 overflow-hidden position-relative">
                    ...
                    <!-- Pulsing indicator -->
                    <div class="position-absolute top-0 end-0 h-100 d-flex align-items-center px-2"
                        style="background: linear-gradient(90deg, transparent 0%, rgba(255,0,0,0.3) 100%);">
            ...
            <div class="about-content">
                <div class="about-text">
                    ...
                    <p class="mb-4" style="color: #cce5ff; line-height: 1.6;">
                        The SNEC Students' Organization (SSO) is a dynamic platform dedicated to fostering students growth,
                        leadership, and community engagement. We serve as the central hub for all student organizations,
                        events, and activities at our institution.
                    </p>
                    <p class="mb-4" style="color: #cce5ff; line-height: 1.6;">
                        Our mission is to empower students by providing opportunities for skill development, networking, and
                        collaborative projects. Through our platform, students can discover organizations that match their
                        interests, participate in events, and develop leadership capabilities.
                    </p>
                    <p class="mb-4" style="color: #cce5ff; line-height: 1.6;">
                        Whether you're looking to join an existing organization, start a new one, or simply participate in
                        campus events, SSO provides the tools and resources you need to make the most of your college
                        experience.
                    </p>
                </div>
                ...
                <div class="col-lg-4 col-md-6  mb-4">
                    ...
                    <div class="card feature-card h-100 border-0">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text">Relive your favorite moments through our extensive event photo galleries.
                            </p>
                ...
                <div class="col-lg-4 col-md-6  mb-4">
                    ...
                    <div class="card feature-card h-100 border-0">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text">Stay updated with notifications for events and organizations you follow.
                            </p>
    ...
    <section id="courses" class="section-padding bg-light">
        <div class="container-fluid">
            <div class="text-center mb-5">
                ...
                <p class="section-subtitle">Upgrade your skills with our certified online programs</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="/images/webdeveloping.jpg" class="card-img-top" alt="Web Development">
                        <div class="card-body">
                            <h5 class="card-title">Web Development Bootcamp</h5>
                            <p class="card-text">
                                Learn HTML, CSS, JavaScript, and Laravel from scratch and build real-world projects.
                            </p>
                            <p class="fw-bold text-primary">Duration: 1 Months</p>
                        </div>
                        <style>
                            .course-card-footer {
                            ...
                            /* Specific override for course buttons to beat global .btn styles */
                            .btn-course-custom {
                                padding: 8px 16px !important;
                                font-size: 0.85rem !important;
                                width: auto !important;
                                /* Override the 250px mobile width */
                                min-width: 0 !important;
                                flex: 1;
                                /* Make them share available space equally */
                        ...
                        <div class="card-footer bg-white border-0 course-card-footer">
                            <a href="{{ route('online-course.index') }}"
                                class="btn btn-primary btn-course-custom">Enroll</a>
                            <button type="button" class="btn btn-secondary btn-course-custom" data-bs-toggle="modal"
                    ...
                    @foreach($upcomingEvents as $event)
                        <div class="col-md-4 mb-4">
                            <div class="card event-card h-100">
                                ...
                                @else
                                    <img src="https://via.placeholder.com/600x300?text=No+Image" class="card-img-top"
                                        alt="{{ $event->title }}">
                                @endif
                                <div class="card-body">
                    ...
                    @foreach($markedGalleryEvents as $event)
                        <div class="col-md-3 col-6">
                            @if($event->cover_image)
                                <img src="{{ asset('storage/' . $event->cover_image) }}" class="img-fluid rounded"
                                    alt="{{ $event->name }}">
                            @else
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><i class="fas fa-map-marker-alt me-2"></i> SAMASTHA National Education Council
                            (SNEC)
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-light">
                    <h5 class="modal-title fw-bold" id="courseDetailsModalLabel">Web Development Bootcamp</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4">
                    <div class="mb-4">
                        <h6 class="text-uppercase text-muted fw-bold small">Course Overview</h6>
                        <p class="lead" style="font-size: 1rem;">
                            Master the art of web development with our intensive bootcamp. Designed for beginners and
                            intermediates, this course takes you from writing your first line of HTML to deploying dynamic
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <h6 class="text-uppercase text-muted fw-bold small">Key Highlights</h6>
                            <ul class="list-unstyled">
                                <li><i class="fas fa-check-circle text-success me-2"></i> Certification</li>
                                <li><i class="fas fa-check-circle text-success me-2"></i> 10+ Live Projects</li>
                                <li><i class="fas fa-check-circle text-success me-2"></i> Career Guidance</li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                    ...
                    <h6 class="text-uppercase text-muted fw-bold small mb-3">Complete Syllabus</h6>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <strong>Module 1: Frontend Fundamentals</strong>
                                <ul class="small text-muted ps-3 mt-1">
                                    <li>HTML5 structure & semantics</li>
                                    <li>CSS3 styling, Flexbox & Grid</li>
                                    <li>Responsive design with Bootstrap 5</li>
                                </ul>
                            </div>
                            <div class="mb-3">
                                <strong>Module 2: JavaScript Essentials</strong>
                                <ul class="small text-muted ps-3 mt-1">
                                    <li>Variables, Data Types, & Loops</li>
                                    <li>DOM Manipulation & Events</li>
                                    <li>ES6+ Features (Arrow functions, etc.)</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <strong>Module 3: Backend with Laravel</strong>
                                <ul class="small text-muted ps-3 mt-1">
                                    <li>PHP Basics & Object Oriented Programming</li>
                                    <li>Laravel MVC Architecture</li>
                                    <li>Database Design (MySQL) & Migrations</li>
                                    <li>CRUD Operations & Authentication</li>
                                </ul>
                            </div>
                            <div class="mb-3">
                                <strong>Module 4: Deployment & Career</strong>
                                <ul class="small text-muted ps-3 mt-1">
                    ...
                    <div class="alert alert-info mt-3 d-flex align-items-center" role="alert">
                        ...
                        <div>
                            <strong>Requirements:</strong> A laptop/PC with internet connection. No prior coding experience
                            required!
                        </div>
                    </div>
                </div>
                <div class="modal-footer bg-light">
                    ...
                    <a href="{{ route('online-course.index') }}" class="btn btn-primary px-4">Enroll Now</a>
                </div>
            </div>
        </div>
    </div>
