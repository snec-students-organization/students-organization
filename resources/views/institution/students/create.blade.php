        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('institution.students.store') }}" class="row g-4" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="whatsapp_number" id="whatsapp_number"
                                   ...
                                   value="{{ old('whatsapp_number') }}" placeholder="Enter WhatsApp number" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="place" id="place"
                                   ...
                                   value="{{ old('place') }}" placeholder="Enter place" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="constituency" id="constituency"
                                   ...
                                   value="{{ old('constituency') }}" placeholder="Enter constituency" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="state" id="state"
                                   ...
                                   value="{{ old('state', 'Kerala') }}" placeholder="Enter state" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="country" id="country"
                                   ...
                                   value="{{ old('country', 'India') }}" placeholder="Enter country" required>
                                ...
                                @foreach($areaOptions as $area)
                                    <div class="col-md-4 col-sm-6">
                                        <label class="area-chip d-flex align-items-center gap-2 px-3 py-2 rounded-3 border {{ in_array($area, $oldAreas) ? 'selected' : '' }}"
                                            ...
                                            <span class="area-icon text-primary"><i class="bi bi-check-circle-fill"></i></span>
