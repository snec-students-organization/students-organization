...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-xl-3 col-md-6">
                <a href="{{ route('admin.online-course.index') }}" style="text-decoration:none;">
                    <div class="card dashboard-card shadow-sm card-gradient-4 text-white">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                <h6>Online Course</h6>
                                <p class="mb-0">Manage Students & Attendance</p>
                            </div>
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-6">
                                <a href="{{ $quickLinks['new_event'] }}"
                                    class="btn btn-outline-primary w-100 quick-action-btn py-3">
                                    <i class="bi bi-plus-circle d-block fs-2 mb-2"></i>New Event
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="{{ $quickLinks['add_organization'] }}"
                                    class="btn btn-outline-success w-100 quick-action-btn py-3">
                        ...
                        <ul class="list-group list-group-flush">
                            @forelse($upcomingEvents as $event)
                                <li class="list-group-item d-flex justify-content-between">
                                    ...
                                    <small
                                        class="text-muted">{{ \Carbon\Carbon::parse($event->start)->format('M d, Y') }}</small>
                                </li>
                            @empty
